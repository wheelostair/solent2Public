...
public class PropertiesDaoTest {
    ...
    public final String TEST_DEFAULT_PROPERTIES = "testDefault.properties";
    ...
    public void testPropertiesDao() {
        PropertiesDao propertiesDao = new PropertiesDao(TEST_PROPERTIES_FILE, TEST_DEFAULT_PROPERTIES);
        ...
        PropertiesDao propertiesDao2 = new PropertiesDao(TEST_PROPERTIES_FILE,TEST_DEFAULT_PROPERTIES);
